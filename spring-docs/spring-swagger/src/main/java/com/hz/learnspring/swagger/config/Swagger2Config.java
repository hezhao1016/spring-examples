package com.hz.learnspring.swagger.config;
...
public class Swagger2Config {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.hz.learnspring.swagger.controller")) // 文档包路径, 一般设置为控制器所在包名
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("Spring 测试使用 Swagger2 构建RESTful API") // 页面标题
